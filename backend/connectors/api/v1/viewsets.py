...
class Testconnectors136892ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS136892_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS136892_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS136892"
